...
static sgx_status_t SGX_CDECL Enclave1_u_sgxprotectedfs_exclusive_file_open(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_u_sgxprotectedfs_check_if_file_exists(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_u_sgxprotectedfs_fread_node(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_u_sgxprotectedfs_fwrite_node(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_u_sgxprotectedfs_fclose(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_u_sgxprotectedfs_fflush(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_u_sgxprotectedfs_remove(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_u_sgxprotectedfs_recovery_file_open(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_u_sgxprotectedfs_fwrite_recovery_node(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_u_sgxprotectedfs_do_file_recovery(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_create_session_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_close_session_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL Enclave1_invoke_service_ocall(void* pms)
{
...
static const struct {
	...
	19,
	{
		...
		(void*)(uintptr_t)Enclave1_u_sgxprotectedfs_exclusive_file_open,
		(void*)(uintptr_t)Enclave1_u_sgxprotectedfs_check_if_file_exists,
		(void*)(uintptr_t)Enclave1_u_sgxprotectedfs_fread_node,
		(void*)(uintptr_t)Enclave1_u_sgxprotectedfs_fwrite_node,
		(void*)(uintptr_t)Enclave1_u_sgxprotectedfs_fclose,
		(void*)(uintptr_t)Enclave1_u_sgxprotectedfs_fflush,
		(void*)(uintptr_t)Enclave1_u_sgxprotectedfs_remove,
		(void*)(uintptr_t)Enclave1_u_sgxprotectedfs_recovery_file_open,
		(void*)(uintptr_t)Enclave1_u_sgxprotectedfs_fwrite_recovery_node,
		(void*)(uintptr_t)Enclave1_u_sgxprotectedfs_do_file_recovery,
		(void*)(uintptr_t)Enclave1_create_session_ocall,
		(void*)(uintptr_t)Enclave1_exchange_report_ocall,
		(void*)(uintptr_t)Enclave1_close_session_ocall,
		(void*)(uintptr_t)Enclave1_invoke_service_ocall,
	}
};

sgx_status_t getSecret(sgx_enclave_id_t eid, char* buf, size_t len)
{
	sgx_status_t status;
	ms_getSecret_t ms;
	ms.ms_buf = buf;
...
sgx_status_t setSecret(sgx_enclave_id_t eid, char* setString)
{
	sgx_status_t status;
	ms_setSecret_t ms;
	ms.ms_setString = setString;
	ms.ms_setString_len = setString ? strlen(setString) + 1 : 0;
...
sgx_status_t ecall_file_read(sgx_enclave_id_t eid, size_t* retval, SGX_FILE* fp, char* readData)
{
	...
	ms.ms_readData_len = readData ? strlen(readData) + 1 : 0;
